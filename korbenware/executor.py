...
from korbenware.dbus import dbus_attr, Str, Bool, DBusField
...
class DBusExecutor(Executor):
    def __init__(self, service, **kwargs):
        ...
        self.obj = service.object('/korbenware/Executor')
    ...
    async def run_xdg_application(self, app, **kwargs):
        ...
        await self.client.korbenware.Executor.run_dbus_application(
            dbus_app
        )
