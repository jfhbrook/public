...
** s7sync
Sie7e Labs FileSync Professional Edition is a work-in-progress file sync tool
built on top of git. It intends to be cross-platform. Available under a MPL
v2.0 license.
** twisted_ipython
